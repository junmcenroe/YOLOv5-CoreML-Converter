...
def main():
    ...
    strides = [8, 16, 32, 64, 128] #for P7 model
    if reverseModel:
        strides.reverse()
    ...
    # anchors = ([28,41,  67,59,  57,141], [144,103,  129,227,  270,205], [
    #            209,452,  455,396,  358,812],[653,922,  1109,570,  1387,1187])  # Take these from the <model>.yml in yolov5 P6_1280 model
    
    anchors = ([211,11,  13,30,  29,20], [30,46,  61,38,  39,92], [
               78,80,  146,66,  79,163],[149,150,  321,143,  157,303],[257,402,  359,290,  524,372])  # Take these from the <model>.yml in yolov5 P6_1280 model
